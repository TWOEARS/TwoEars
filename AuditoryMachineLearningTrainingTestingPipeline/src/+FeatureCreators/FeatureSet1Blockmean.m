...
% finite differences.
    ...
    methods (Access = public)
        ...
        function x = constructVector( obj )
            ...
            % afeIdx 4: onsetStrengths
            onsR = obj.makeBlockFromAfe( 4, ... % afeIdx,
                1, ... % chIdx
                @(a)(compressAndScale( a.Data, 0.33 )), ... % func
                {@(a)(a.Name),@(a)([num2str(numel(a.cfHz)) '-ch']),@(a)(a.Channel)},... % grps
                {'t'}, ... % varargin: time index
                {@(a)(strcat('f', arrayfun(@(f)(num2str(f)), a.cfHz,'UniformOutput', false)))} ); % varargin: frequency bin
